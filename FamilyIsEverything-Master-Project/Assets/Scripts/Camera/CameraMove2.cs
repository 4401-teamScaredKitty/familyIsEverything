...
public class CameraMove2 : MonoBehaviour
{
    ...
    void ZoomInonTarget()
    {
        position.dstFromTarget += zoomInput * position.zoomSmooth * Time.deltaTime;

        if (position.dstFromTarget > position.maxZoom)
        {
            position.dstFromTarget = position.maxZoom;
        }
        if (position.dstFromTarget < position.minZoom)
        {
            position.dstFromTarget = position.minZoom;
        }
    }
